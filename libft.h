...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/17 13:02:17 by ribana-b          #+#    #+#             */
/*   Updated: 2023/10/20 04:03:41 by ribana-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_strncmp(const char *s1, const char *s2, size_t bytes);
void	*ft_memchr(const void *s, int c, size_t bytes);
int		ft_memcmp(const void *s1, const void *s2, size_t bytes);
...
char	*ft_substr(const char *s, unsigned int start, size_t bytes);
